...
const WIDTH_CLASS =
    'w-screen h-full lg:w-[520px] lg:h-auto lg:aspect-[3/4] xl:w-[820px] xl:h-[1180px] laptop:w-[640px] laptop:aspect-auto 2xl:w-[860px] xl:h-[1220px] 2xl:aspect-auto'
...
const Home = () => {
    ...
    return (
        ...
        >
            <Head>
                <title>Undangan Pernikahan Anita & Ali</title>
                <meta
                    name="viewport"
