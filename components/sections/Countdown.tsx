...
const Countdown: React.FC<CountdownProps> = ({ isActive }) => {
    ...
    return (
        <RCountdown
            date={new Date('October 21, 2023 11:00:00 GMT+07:00')}
            renderer={props => (
                <Renderer
                    isActive={isActive}
                    {...props}
            ...
            >
                <div>
                    ...
                    <ul className="mt-2 text-lg leading-none md:text-2xl laptop:text-lg 2xl:text-2xl md:mt-4 font-BebasNeue">
                        <li>Sabtu, 21 Oktober 2023</li>
                        <li>Pukul 09:00 - selesai WIB</li>
                    </ul>
                </div>
                ...
                <div className="mt-10 md:mt-14 lg:mt-28 laptop:mt-10 2xl:mt-20">
                    ...
                    <ul className="mt-2 text-lg leading-none md:text-2xl laptop:text-lg 2xl:text-2xl md:mt-4 font-BebasNeue">
                        ...
                        <br />
                        <li>
                            Kp Tarikolot RT 10 / RW 03 Desa Cimande <br /> Kec
                            Caringin <br /> Kab. Bogor
                        </li>
                    </ul>
                </div>
            </div>
